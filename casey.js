...
var session = conf.session.replace(/CASEYRHODES-MD;;;=>/g,"");
...
function createNotification(deletedMessage) {
  const deletedBy = deletedMessage.key.participant || deletedMessage.key.remoteJid;
  let notification = `*❣️CASEYRHODES MD ANTIDELETE😋*\n\n`;
...
// CASEYRHODES MD DID EVERYTHING ,,,DO NOT COPY ...
...
/******** fin d'evenement groupe update *************************/
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            else if (connection === 'open') {await zk.groupAcceptInvite("HednkHQXSV77Czp1U8cjQS");
