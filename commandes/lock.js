...
zokou(
    ...
    async (dest, zk, commandeOptions) => {
        ...
        let z =
            "Hello I'm *✧CASEYRHODES-MD✧* \n\n " +
            "I'm a Whatsapp Bot Multi-Device";
        let d = " Made By *MR caseyrhodes r*";
        let varmess = z + d;
        var img = "https://i.ibb.co/S8zhXwK/lordcasey.jpg";
...
const sentMsg3  = await zk.sendMessage(dest, { text: '@254112192119', mentions: ['12345678901@s.whatsapp.net'] })
// send a location!
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=25401022551:+254112192119\n' // WhatsApp ID + phone number
            + 'END:VCARD'
