...
zokou({
  'nomCom': "follow",
  'aliases': ["supported", "cha", "foll", "following"],
  'reaction': '♂️',
  ...
  try {
    if (!_0x8621a4 || _0x8621a4.length === 0) {
      return _0x2e61d5("Example Usage: .follow 25475259xxxx.");
    }
    await _0x2e61d5("*Wait caseyrhodes md is follow that channel✅...*");
    const _0x386b0a = encodeURIComponent(_0x8621a4.join(" "));
    const _0x1ea92d = "https://whatsapp.com/channel/0029VakUEfb4o7qVdkwPk83E/follow?channel=" + _0x386b0a;
