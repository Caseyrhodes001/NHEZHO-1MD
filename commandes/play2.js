...
zokou({
  ...
  try {
    ...
    const apis = [
      ...
      `https://apis.giftedtech.web.id/api/download/dlmp3?url=${encodeURIComponent(videoUrl)}`
    ];
    ...
    const messagePayloads = [
      {
      caption: `\n*CASEYRHODES MD AUDIOS*\n
╭┈┈┈⊷
┊ *Made:* in kenya
┊ *Quality:* High
┊ *Powered:* by CASEYRHODES
╰┈┈┈┈┈┈┈┈┈┈┈┈┈⊷
🌐 *Bot Repo:* https://github.com/caseyweb/NHEZHO-MD
...
zokou({
  ...
  try {
    ...
    const apis = [
      ...
      `https://apis.giftedtech.web.id/api/download/dlmp3=${encodeURIComponent(videoUrl)}`
    ];
