...
zokou({
  ...
  const _0x41d2b1 = {
    'externalAdReply': {
      'title': "cαѕєчrhσdєѕ md ulrα ѕpєєd rєѕpσnѕє",
  ...
  const _0x54ea81 = {
    'displayName': "CASEYRHODES MD Support",
    'vcard': "BEGIN:VCARD\nVERSION:3.0\nFN: NJABULO MD\nORG: NJABULO MD Nexus;\nTEL;type=CELL;type=VOICE;waid=254112192119:+254101022551\nEND:VCARD"
  };
  await _0x41d5d3.sendMessage(_0x4cfdc6, {
    'text': "𝐂𝐀𝐒𝐄𝐘𝐑𝐇𝐎𝐃𝐄𝐒 𝐌𝐃",
    'contextInfo': _0x41d2b1,
    'contacts': {
      'displayName': "CASEYRHODES MD Verified Contact",
      'contacts': [_0x54ea81]
    },
    'quoted': _0x2c968b
  });
...
zokou({
  ...
  const _0xae590 = {
    'externalAdReply': {
      'title': "𝐂𝐀𝐒𝐄𝐘𝐑𝐇𝐎𝐃𝐄𝐒 𝐌𝐃 𝐬𝐲𝐬𝐭𝐞𝐦 𝐮𝐩𝐭𝐢𝐦𝐞",
